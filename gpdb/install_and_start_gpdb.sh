...
pushd /data
  ...
  echo "host all all 0.0.0.0/0 gss include_realm=1" >> /data/master/gpsne-1/pg_hba.conf
  echo "krb_server_keyfile = '/code/gpdb-kerberos.keytab'" >> /data/master/gpsne-1/postgresql.conf
